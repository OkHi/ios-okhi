...
SWIFT_CLASS("_TtC4OkHi9OkHiError")
...
SWIFT_CLASS("_TtC4OkHi13OkHiException")
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull NO_ACTIVE_SESSION_CODE;)
+ (NSString * _Nonnull)NO_ACTIVE_SESSION_CODE SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull CLOSE_IN_PROGRESS_CODE;)
+ (NSString * _Nonnull)CLOSE_IN_PROGRESS_CODE SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC4OkHi12OkHiLocation")
...
@class OkHiUser;
SWIFT_CLASS("_TtC4OkHi19OkHiSuccessResponse")
...
SWIFT_CLASS("_TtC4OkHi8OkHiUser")
...
static NSString * _Nonnull const OkVerifyErrorDomain = @"OkHi.OkVerifyError";
