...
#ifndef IOSOKHI_SWIFT_H
#define IOSOKHI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="iOSOkHi",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7iOSOkHi8GeoPoint")
...
SWIFT_CLASS("_TtC7iOSOkHi11OkAnalytics")
...
@class CLRegion;
@interface OkAnalytics (SWIFT_EXTENSION(iOSOkHi)) <CLLocationManagerDelegate>
...
SWIFT_CLASS("_TtC7iOSOkHi9OkCollect")
...
SWIFT_CLASS("_TtC7iOSOkHi4OkHi")
@interface OkHi : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC7iOSOkHi14OkHiAppContext")
...
SWIFT_CLASS("_TtC7iOSOkHi11OkHiAppMeta")
...
SWIFT_CLASS("_TtC7iOSOkHi8OkHiAuth")
...
SWIFT_CLASS("_TtC7iOSOkHi10OkHiConfig")
...
/// The OkHiError class extends the Error class to provide additional information regarding the type of errors thrown while running any OkHiLibraries. It contains static string properties that can be used to evaluate the kind of errors being thrown and handle them appropriately.
SWIFT_CLASS("_TtC7iOSOkHi9OkHiError")
@interface OkHiError : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

enum OkVerifyError : NSInteger;
SWIFT_CLASS("_TtC7iOSOkHi13OkHiException")
@interface OkHiException : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull FATAL_EXIT;)
+ (NSString * _Nonnull)FATAL_EXIT SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull NETWORK_ERROR_CODE;)
+ (NSString * _Nonnull)NETWORK_ERROR_CODE SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull UNKNOWN_ERROR_CODE;)
+ (NSString * _Nonnull)UNKNOWN_ERROR_CODE SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull PERMISSION_DENIED_CODE;)
+ (NSString * _Nonnull)PERMISSION_DENIED_CODE SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull SERVICE_UNAVAILABLE_CODE;)
+ (NSString * _Nonnull)SERVICE_UNAVAILABLE_CODE SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull UNSUPPORTED_DEVICE;)
+ (NSString * _Nonnull)UNSUPPORTED_DEVICE SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull INVALID_PHONE_CODE;)
+ (NSString * _Nonnull)INVALID_PHONE_CODE SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull UNAUTHENTICATED;)
+ (NSString * _Nonnull)UNAUTHENTICATED SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull USER_CLOSED;)
+ (NSString * _Nonnull)USER_CLOSED SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, readonly, copy) NSString * _Nonnull code;
@property (nonatomic, readonly, copy) NSString * _Nullable message;
- (nonnull instancetype)initWithCode:(NSString * _Nonnull)code message:(NSString * _Nullable)message OBJC_DESIGNATED_INITIALIZER;
- (NSString * _Nonnull)userFriendlyMessage SWIFT_WARN_UNUSED_RESULT;
+ (OkHiException * _Nonnull)fromOkHiError:(OkHiError * _Nonnull)error SWIFT_WARN_UNUSED_RESULT;
+ (OkHiException * _Nonnull)fromOkVerifyError:(enum OkVerifyError)error SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

/// Defines OkHiLocation class once an address has been successfully created by the user.
SWIFT_CLASS("_TtC7iOSOkHi12OkHiLocation")
@interface OkHiLocation : NSObject
/// Initializes OkHiLocation class
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class CLLocation;
SWIFT_CLASS("_TtC7iOSOkHi19OkHiLocationManager")
...
SWIFT_CLASS("_TtC7iOSOkHi19OkHiLocationService")
...
SWIFT_PROTOCOL("_TtP7iOSOkHi27OkHiLocationServiceDelegate_")
@protocol OkHiLocationServiceDelegate
...
@class OkHiUser;
SWIFT_CLASS("_TtC7iOSOkHi19OkHiSuccessResponse")
@interface OkHiSuccessResponse : NSObject
@property (nonatomic, readonly, strong) OkHiUser * _Nonnull user;
@property (nonatomic, readonly, strong) OkHiLocation * _Nonnull location;
- (nonnull instancetype)initWithUser:(OkHiUser * _Nonnull)user location:(OkHiLocation * _Nonnull)location OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

/// Defines  OkHiTheme class
SWIFT_CLASS("_TtC7iOSOkHi9OkHiTheme")
@interface OkHiTheme : NSObject
/// Initializes OkHiTheme class
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
/// Initializes OkHiTheme with Primary color (buttons, labels etc)
/// \param primaryColor hex string color e.g  “#FFFFFF”
///
///
/// returns:
/// instance of OkHiTheme
- (OkHiTheme * _Nonnull)withPrimaryColor:(NSString * _Nonnull)primaryColor SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC7iOSOkHi8OkHiUser")
@interface OkHiUser : NSObject
/// Initalizes OkHiUser class
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC7iOSOkHi13OkPreferences")
@interface OkPreferences : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC7iOSOkHi8OkVerify")
@interface OkVerify : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@interface OkVerify (SWIFT_EXTENSION(iOSOkHi)) <CLLocationManagerDelegate>
- (void)locationManagerDidChangeAuthorization:(CLLocationManager * _Nonnull)manager;
- (void)locationManager:(CLLocationManager * _Nonnull)manager didChangeAuthorizationStatus:(CLAuthorizationStatus)status;
...
@interface OkVerify (SWIFT_EXTENSION(iOSOkHi))
- (void)startMonitoring;
+ (void)startMonitoring;
@end

typedef SWIFT_ENUM(NSInteger, OkVerifyError, open) {
  OkVerifyErrorInvalidUrl = 0,
  OkVerifyErrorInvalidData = 1,
  OkVerifyErrorNetworkError = 2,
  OkVerifyErrorUnknownError = 3,
  OkVerifyErrorUnableToParseResponse = 4,
  OkVerifyErrorInvalidPhoneNumber = 5,
  OkVerifyErrorUnauthorized = 6,
  OkVerifyErrorAddressVerificationFailure = 7,
  OkVerifyErrorAddressVerificationDenied = 8,
  OkVerifyErrorDenied = 9,
  OkVerifyErrorInVerification = 10,
  OkVerifyErrorPermissionDenied = 11,
  OkVerifyErrorServiceUnavailable = 12,
  OkVerifyErrorMaxAttempts = 13,
};
static NSString * _Nonnull const OkVerifyErrorDomain = @"iOSOkHi.OkVerifyError";

@class NSEntityDescription;
@class NSManagedObjectContext;
SWIFT_CLASS("_TtC7iOSOkHi16OkVerifyGeofence")
@interface OkVerifyGeofence : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end

@interface OkVerifyGeofence (SWIFT_EXTENSION(iOSOkHi))
...
SWIFT_CLASS("_TtC7iOSOkHi26OkVerifyGeofenceTransition")
@interface OkVerifyGeofenceTransition : NSManagedObject
- (nonnull instancetype)initWithEntity:(NSEntityDescription * _Nonnull)entity insertIntoManagedObjectContext:(NSManagedObjectContext * _Nullable)context OBJC_DESIGNATED_INITIALIZER;
@end

@class NSDate;
@interface OkVerifyGeofenceTransition (SWIFT_EXTENSION(iOSOkHi))
